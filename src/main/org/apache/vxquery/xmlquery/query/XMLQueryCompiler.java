...
public class XMLQueryCompiler {
    public static Module compile(ModuleNode moduleNode, CompilerControlBlock ccb) throws SystemException {
        return compile(NoopXQueryCompilationListener.INSTANCE, moduleNode, ccb);
    }

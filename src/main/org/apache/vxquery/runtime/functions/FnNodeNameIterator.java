...
public class FnNodeNameIterator extends AbstractEagerlyEvaluatedFunctionIterator {
    public FnNodeNameIterator(RegisterAllocator allocator, Function fn, RuntimeIterator[] arguments,
            StaticContext ctx) {
    ...
    public Object evaluateEagerly(CallStackFrame frame) throws SystemException {
        ...
        if (n == null || !n.getDMOKind().hasNodeName()) {
            return null;
        }
        final int nc = n.getNodeNameCode();
        return frame.getRuntimeControlBlock().getAtomicValueFactory().createQName(n.getNameCache(), nc);
    }
}
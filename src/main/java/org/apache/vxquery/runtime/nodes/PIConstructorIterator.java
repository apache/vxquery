...
public class PIConstructorIterator extends AbstractEagerlyEvaluatedIterator {
    ...
    public Object evaluateEagerly(CallStackFrame frame) throws SystemException {
        ...
        QNameValue target = (QNameValue) ni.evaluateEagerly(frame);
        StringValue data = (StringValue) ci.evaluateEagerly(frame);
        return nf.createProcessingInstruction(target, data);
    }
}
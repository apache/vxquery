...
public final class ValueLtComparator implements ValueComparator {
    public static final ValueComparator INSTANCE = new ValueLtComparator();

    private ValueLtComparator() {
    }

...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xsl:template match="/">
        <xsl:for-each select="/functions/function/@name[not(. = ../preceding-sibling::function/@name)]">
            public static final javax.xml.namespace.QName <xsl:value-of select="translate(., 'abcdefghijklmnopqrstuvwxyz-:', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ__')"/>_QNAME

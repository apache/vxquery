...
public class IndexConstructorDocScalarEvaluatorFactory extends AbstractTaggedValueArgumentScalarEvaluatorFactory {
    private static final long serialVersionUID = 1L;

    public IndexConstructorDocScalarEvaluatorFactory(IScalarEvaluatorFactory[] args) {
        super(args);
    }
            ...
            private void indexXmlFiles(File collectionDirectory, IndexWriter writer) throws SystemException,
                ...
                for (File file : collectionDirectory.listFiles()) {
                    ...
                    if (FunctionHelper.readableXmlFile(file.getPath())) {
                        ...
                        IndexBuilderDoc ibuilder = new IndexBuilderDoc(nodep, writer,

...
public abstract class newAbstractTaggedValueArgumentUnnestingEvaluator implements IUnnestingEvaluator {
    private final IScalarEvaluator[] args;

    protected final TaggedValuePointable[] tvps;

    public newAbstractTaggedValueArgumentUnnestingEvaluator(IScalarEvaluator[] args) {
        this.args = args;

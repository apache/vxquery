        ...
        return new AbstractUnaryInputUnaryOutputOperatorNodePushable() {
            ...
            public void nextFrame(ByteBuffer buffer) throws HyracksDataException {
                ...
                if (collectionModifiedName.contains("hdfs://")) {
                    ...
                    if (functionCall.equals(BuiltinFunctions.FN_BUILD_INDEX_ON_COLLECTION_1.getFunctionIdentifier().getName())) {
                        ...
                        if (collectionDirectory.exists() && collectionDirectory.isDirectory()) {
                            ...
                            try {
                                indexConstructorUtil.evaluate(collectionModifiedName, indexModifiedName, result,
                                        stringp, bbis, di, sb, abvs, nodeIdProvider, abvsFileNode, nodep, false, nodeId);
                    ...
                    } else if (functionCall.equals(BuiltinFunctions.FN_UPDATE_INDEX_1.getFunctionIdentifier().getName())) {
                    ...
                    } else if (functionCall.equals(BuiltinFunctions.FN_DELETE_INDEX_1.getFunctionIdentifier().getName()
                            )) {
                        indexModifiedName = indexCentralizerUtil.getIndexForCollection(collectionModifiedName);
                        IndexUpdater updater = new IndexUpdater(indexModifiedName, result, stringp, bbis, di, sb, abvs,
                                nodeIdProvider, abvsFileNode, nodep, nodeId);
                    ...
                    } else if (functionCall.equals(BuiltinFunctions
                            .FN_COLLECTION_FROM_INDEX_2.getFunctionIdentifier().getName())) {
                        indexModifiedName = indexCentralizerUtil.getIndexForCollection(collectionModifiedName);
                        ...
                        throw new HyracksDataException(
                                "Unsupported function call (" + functionCall + ")");
                    }
                }
            }

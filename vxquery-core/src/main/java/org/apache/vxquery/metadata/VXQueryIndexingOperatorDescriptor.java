    ...
    public IOperatorNodePushable createPushRuntime(IHyracksTaskContext ctx,
        ...
        return new AbstractUnaryInputUnaryOutputOperatorNodePushable() {
            ...
            public void nextFrame(ByteBuffer buffer) throws HyracksDataException {
                ...
                if (AbstractCollectionRule.functionCall.getFunctionIdentifier()
                        .equals(BuiltinFunctions.FN_BUILD_INDEX_ON_COLLECTION_2.getFunctionIdentifier())) {
                    ...
                    if (collectionDirectory.exists() && collectionDirectory.isDirectory()) {
                        ...
                        try {
                            indexConstructorUtil
                                    .evaluate(collectionModifiedName, indexModifiedName, result, stringp, bbis, di, sb,
                                            abvs, nodeIdProvider, abvsFileNode, nodep, false, nodeId);
                ...
                } else if (AbstractCollectionRule.functionCall.getFunctionIdentifier()
                        .equals(BuiltinFunctions.FN_UPDATE_INDEX_1.getFunctionIdentifier())) {
                    ...
                    try {
                        ...
                        .equals(BuiltinFunctions.FN_DELETE_INDEX_1.getFunctionIdentifier())) {
                    IndexUpdater updater = new IndexUpdater(indexModifiedName, result, stringp, bbis, di,
                            sb, abvs, nodeIdProvider, abvsFileNode, nodep, nodeId);
                    try {
                        updater.setup();
                    ...
                    throw new HyracksDataException("Unsupported function call (" + AbstractCollectionRule
                            .functionCall + ")");
                }

...
public class IndexBuilderElementPath {
    ...
    public IndexBuilderElementPath(IPointable tree, IndexWriter inwriter, String infilepath) {
    ...
    private void printTaggedValuePointable(PrintStream ps, TaggedValuePointable tvp, String myid, String epath) {
        ...
        //doc is a lucene document that will be added to the index.
        Document doc = new Document();

        doc.add(new StringField("contents", test.contents(), Field.Store.YES));
        doc.add(new StringField("id", test.id(), Field.Store.YES));
        doc.add(new StringField("type", test.type(), Field.Store.YES));

        //Lucene was not working with "/" so I put banana
        ...
        doc.add(new StringField("epath", betterepath, Field.Store.YES));
        try {

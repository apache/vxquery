...
public final class ValueEqComparator implements ValueComparator {
    public static final ValueComparator INSTANCE = new ValueEqComparator();

    private ValueEqComparator() {
    }
    ...
    public boolean compareGDay(GDayValue v1, GDayValue v2, int implicitTZ) throws SystemException {
        return v1.equals(v2, implicitTZ);
    }

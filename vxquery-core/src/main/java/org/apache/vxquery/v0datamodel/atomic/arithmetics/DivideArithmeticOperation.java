...
public class DivideArithmeticOperation implements ArithmeticOperation {
    public static final ArithmeticOperation INSTANCE = new DivideArithmeticOperation();

    private DivideArithmeticOperation() {
    }
    ...
    public XDMItem operateDecimal(AtomicValueFactory avf, NumericValue v1, NumericValue v2) throws SystemException {
        ...
        return avf.createDecimal(d1.divide(d2, scale, RoundingMode.DOWN));
    }

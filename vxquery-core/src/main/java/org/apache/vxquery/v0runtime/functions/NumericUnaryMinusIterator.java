...
public class NumericUnaryMinusIterator extends AbstractUnaryNumericFunctionIterator {
    public NumericUnaryMinusIterator(RegisterAllocator rAllocator, Function fn, RuntimeIterator[] arguments, StaticContext ctx) {

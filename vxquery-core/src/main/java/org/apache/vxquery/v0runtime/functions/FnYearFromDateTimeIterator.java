...
public class FnYearFromDateTimeIterator extends AbstractEagerlyEvaluatedFunctionIterator {
    public FnYearFromDateTimeIterator(RegisterAllocator rAllocator, Function fn, RuntimeIterator[] arguments,
            StaticContext ctx) {
    ...
    public Object evaluateEagerly(CallStackFrame frame) throws SystemException {
        ...
        return frame.getRuntimeControlBlock().getAtomicValueFactory().createInteger(value.getYearValue());
    }
}
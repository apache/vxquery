...
public class FnTrueIterator extends AbstractEagerlyEvaluatedFunctionIterator {
    public FnTrueIterator(RegisterAllocator rAllocator, Function fn, RuntimeIterator[] arguments, StaticContext ctx) {

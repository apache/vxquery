...
public class FnYearFromDateIterator extends AbstractEagerlyEvaluatedFunctionIterator {
    public FnYearFromDateIterator(RegisterAllocator rAllocator, Function fn, RuntimeIterator[] arguments,
            StaticContext ctx) {
    ...
    public Object evaluateEagerly(CallStackFrame frame) throws SystemException {
        DateValue value = (DateValue) arguments[0].evaluateEagerly(frame);
        if (value == null) {
            return null;
        }

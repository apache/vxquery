...
public class FnTranslateIterator extends AbstractEagerlyEvaluatedFunctionIterator {
    public FnTranslateIterator(RegisterAllocator rAllocator, Function fn, RuntimeIterator[] arguments,
            StaticContext ctx) {
    ...
    public Object evaluateEagerly(CallStackFrame frame) throws SystemException {
        ...
        CharSequence mString = RuntimeUtils.fetchItemEagerly(arguments[1], frame).getStringValue();
        CharSequence tString = RuntimeUtils.fetchItemEagerly(arguments[2], frame).getStringValue();

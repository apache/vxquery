...
public class OpExtSortNodesDescIterator extends AbstractItemSortingIterator {
    private static final Comparator<XDMItem> SORT_NODE_DESC_COMPARATOR = new Comparator<XDMItem>() {
        @Override
    ...
    public OpExtSortNodesDescIterator(RegisterAllocator rAllocator, Function fn, RuntimeIterator[] arguments,
            StaticContext ctx) {
    ...
    protected Comparator<XDMItem> getComparator() {
        return SORT_NODE_DESC_COMPARATOR;
    }
}
...
public class OpExtSortAndDistinctNodesDescIterator extends AbstractItemSortingAndDistinctIterator {
    public OpExtSortAndDistinctNodesDescIterator(RegisterAllocator rAllocator, Function fn,

...
public class XTestCmdLineOptions {
    @Option(name = "-port", required = true, usage = "Port for web server to listen on")
    int port;

    @Option(name = "-xqtsbase", required = true, usage = "XQTS Base Directory")
    String xqtsBase;

    @Option(name = "-threads", required = true, usage = "Number of threads")
    int threads;

...
public class InstanceofExpression extends TypeExpression {
    public InstanceofExpression(StaticContext ctx, Expression input, SequenceType type) {
        super(ctx, input, type);
    }

    @Override
    public final ExprTag getTag() {
        return ExprTag.INSTANCEOF;
    }

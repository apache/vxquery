...
public class ElementNodeConstructorExpression extends ElementOrAttributeNodeConstructorExpression {
    public ElementNodeConstructorExpression(StaticContext ctx, Expression name, Expression content) {

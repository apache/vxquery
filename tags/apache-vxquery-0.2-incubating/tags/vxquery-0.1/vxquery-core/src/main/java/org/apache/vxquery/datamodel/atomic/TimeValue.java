...
public class TimeValue extends AbstractDateTimeValue {
    TimeValue(XMLGregorianCalendar calendar) {
        this(calendar, BuiltinTypeRegistry.XS_TIME);
    }

    TimeValue(XMLGregorianCalendar calendar, AtomicType type) {
        super(type, calendar);
    }

...
public final class AddArithmeticOperation implements ArithmeticOperation {
    public static final ArithmeticOperation INSTANCE = new AddArithmeticOperation();

    private AddArithmeticOperation() {
    }
    ...
    public XDMItem operateDateDayTimeDuration(AtomicValueFactory avf, DateValue v1, DurationValue v2) {
        ...
        copy.add(v2.getInternalDuration());
    ...
    public XDMItem operateInteger(AtomicValueFactory avf, NumericValue v1, NumericValue v2) {
        return avf.createInteger(v1.getIntegerValue().add(v2.getIntegerValue()));
    }

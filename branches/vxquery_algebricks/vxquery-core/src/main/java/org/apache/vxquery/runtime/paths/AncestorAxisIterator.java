...
public class AncestorAxisIterator extends AbstractLazilyEvaluatedIterator {
    ...
    public AncestorAxisIterator(RegisterAllocator rAllocator, RuntimeIterator input, Filter<XDMValue> filter) {
        super(rAllocator);
        this.input = input;
        this.filter = filter;
    ...
    public Object next(CallStackFrame frame) throws SystemException {
        ...
        while (true) {
            ...
            XDMNode parent = cNode.getParent();
            currentNode.set(regs, parent);

...
public class ElementConstructorIterator extends AbstractEagerlyEvaluatedIterator {
    ...
    public ElementConstructorIterator(RegisterAllocator rAllocator, RuntimeIterator ni, RuntimeIterator ci) {
        super(rAllocator);
        this.ni = ni;
        this.ci = ci;
    }
    ...
    public Object evaluateEagerly(CallStackFrame frame) throws SystemException {
        ...
        ci.open(frame);
        return nf.createElement(name, null, RuntimeUtils.createCloseableIterator(frame, ci));
    }
}
...
public class ValueEqComparisonIterator extends AbstractValueComparisonIterator {
    public ValueEqComparisonIterator(RegisterAllocator rAllocator, Function fn, RuntimeIterator[] arguments,
            StaticContext ctx) {

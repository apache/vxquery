...
public class GeneralGeComparisonIterator extends AbstractGeneralComparisonIterator {
    public GeneralGeComparisonIterator(RegisterAllocator rAllocator, Function fn, RuntimeIterator[] arguments,
            StaticContext ctx) {
    ...
    protected ValueComparator getComparator() {
        return ValueGeComparator.INSTANCE;
    }
}
...
public final class ValueGeComparator implements ValueComparator {
    ...
    public boolean compareString(StringValue v1, StringValue v2, Collation collation) throws SystemException {
        return !ValueLtComparator.INSTANCE.compareString(v1, v2, collation);
    }

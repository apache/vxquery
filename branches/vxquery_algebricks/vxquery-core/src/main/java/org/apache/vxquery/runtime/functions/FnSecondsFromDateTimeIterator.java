...
public class FnSecondsFromDateTimeIterator extends AbstractEagerlyEvaluatedFunctionIterator {
    ...
    public Object evaluateEagerly(CallStackFrame frame) throws SystemException {
        ...
        int seconds = value.getSecondValue();
        BigDecimal fSeconds = value.getFractionalSecondValue();
        return frame.getRuntimeControlBlock().getAtomicValueFactory().createDecimal(
                fSeconds == null ? BigDecimal.valueOf(seconds) : fSeconds.add(BigDecimal.valueOf(seconds)));
    }
}
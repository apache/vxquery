...
public class ModArithmeticOperation implements ArithmeticOperation {
    public static final ArithmeticOperation INSTANCE = new ModArithmeticOperation();

    private ModArithmeticOperation() {
    }
    ...
    public XDMItem operateDecimal(AtomicValueFactory avf, NumericValue v1, NumericValue v2) throws SystemException {
        ...
        return avf.createDecimal(d1.remainder(d2));
    }
    ...
    public XDMItem operateInteger(AtomicValueFactory avf, NumericValue v1, NumericValue v2) throws SystemException {
        return avf.createInteger(v1.getIntegerValue().mod(v2.getIntegerValue()));
    }
